...
function dataManipulation(dataSet, sheet) {
  var newRows = [];
  var newIndex = -1;
...
function main() {
  ...
  var updatingSheet =
    SpreadsheetApp.getActiveSpreadsheet().getSheetByName("IGTa/e");
  var startDate = Utilities.formatDate(
    sheetInterface.getRange(8, 2).getValue(),
    "GMT+2",
    "dd/MM/yyyy"
  );
  var interfaceSheet =
  ...
  try {
    ...
    var dataSet_APDs = dataExtraction(queryAPDs);
    var APDs = dataManipulation(dataSet_APDs, updatingSheet);

    //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    var queryREs = `query{allOpportunityApplication(\n\t\tfilters:\n\t\t{\n      opportunity_home_mc:1559\n      date_realized:{from:\"${startDate}\"}\n\t\t\tprogrammes:[8,9]\n      \n\t\t}\n    \n    page:1\n    per_page:3000\n\t)\n\t{\n    paging\n    {\n      total_items\n    }\n\t\tdata\n    {\n      person\n      {\n        id\n        full_name\n        email\n        home_lc\n        {\n          name\n        }\n        home_mc\n        {\n          name\n        }\n      }\n      opportunity\n      {\n    organisation\n{name}\n    id\n        programme\n        { short_name_display }\n        host_lc\n        {\n          name\n        }\n        home_mc\n        {\n          name\n        }\n        remote_opportunity\n        project_fee\n        earliest_start_date\n        latest_end_date\n        specifics_info{\n          salary\n          salary_currency{\n            alphabetic_code\n          }\n        }\n        opportunity_duration_type{\n          duration_type\n          salary\n        }\n        \n      }\n      slot{\n        start_date\n        end_date\n      }\n      status\n      updated_at\n      date_approved\n      date_realized\n      experience_end_date\n       standards{\n        \n        standard_option{\n          meta\n        }\n \n      }\n  \n     }\n  }\n}`;

    var dataSet_REs = dataExtraction(queryREs);
    var REs = dataManipulation(dataSet_REs, updatingSheet);
    //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

    var queryRemote = `query{allOpportunityApplication(\n\t\tfilters:\n\t\t{\n      opportunity_home_mc:1559\n      date_remote_realized:{from:\"${startDate}\"}\n\t\t\tprogrammes:[8,9]\n     \n\t\t}\n    \n    page:1\n    per_page:3000\n\t)\n\t{\n    paging\n    {\n      total_items\n    }\n\t\tdata\n    {\n      person\n      {\n        id\n        full_name\n        email\n        home_lc\n        {\n          name\n        }\n        home_mc\n        {\n          name\n        }\n      }\n      opportunity\n      {\n    organisation\n{name}\n    id\n        programme\n        { short_name_display }\n        host_lc\n        {\n          name\n        }\n        home_mc\n        {\n          name\n        }\n        remote_opportunity\n        project_fee\n        earliest_start_date\n        latest_end_date\n        specifics_info{\n          salary\n          salary_currency{\n            alphabetic_code\n          }\n        }\n        opportunity_duration_type{\n          duration_type\n          salary\n        }\n        \n      }\n      slot{\n        start_date\n        end_date\n      }\n      status\n      updated_at\n      date_approved\n      date_realized\n      experience_end_date\n       standards{\n        \n        standard_option{\n          meta\n        }\n \n      }\n  \n     }\n  }\n}`;

    var dataSet_Remote_REs = dataExtraction(queryRemote);
    var Remote_REs = dataManipulation(dataSet_Remote_REs, updatingSheet);
    //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    var queryFIs = `query{allOpportunityApplication(\n\t\tfilters:\n\t\t{\n      opportunity_home_mc:1559\n      experience_end_date:{from:\"${startDate}\"}\n\t\t\tprogrammes:[8,9]\n  statuses:[\"finished\",\"completed\"]     \n\t\t}\n    \n    page:1\n    per_page:3000\n\t)\n\t{\n    paging\n    {\n      total_items\n    }\n\t\tdata\n    {\n      person\n      {\n        id\n        full_name\n        email\n        home_lc\n        {\n          name\n        }\n        home_mc\n        {\n          name\n        }\n      }\n      opportunity\n      {\n    organisation\n{name}\n    id\n        programme\n        { short_name_display }\n        host_lc\n        {\n          name\n        }\n        home_mc\n        {\n          name\n        }\n        remote_opportunity\n        project_fee\n        earliest_start_date\n        latest_end_date\n        specifics_info{\n          salary\n          salary_currency{\n            alphabetic_code\n          }\n        }\n        opportunity_duration_type{\n          duration_type\n          salary\n        }\n        \n      }\n      slot{\n        start_date\n        end_date\n      }\n      status\n      updated_at\n      date_approved\n      date_realized\n      experience_end_date\n       standards{\n        \n        standard_option{\n          meta\n        }\n \n      }\n  \n     }\n  }\n}`;

    var dataSet_FIs = dataExtraction(queryFIs);
    var FIs = dataManipulation(dataSet_FIs, updatingSheet);
    //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    var dataSet_Breaks = dataExtraction(queryBreaks);
    updateBreaks(updatingSheet, dataSet_Breaks);

    var now = new Date();
    updateDate = interfaceSheet.getRange(12, 4).setValue(now);
    updateDate = interfaceSheet.getRange(12, 3).setValue("Succeed");
  } catch (e) {
    Logger.log(e.toString());
    var now = new Date();
    updateDate = interfaceSheet.getRange(12, 4).setValue(now);
    updateDate = interfaceSheet.getRange(12, 3).setValue("Failed");
  }
}

function updateECBChecks() {
  var updatingSheet =
    SpreadsheetApp.getActiveSpreadsheet().getSheetByName("IGTa/e");
...
function updateBreaks(sheet, breaks) {
